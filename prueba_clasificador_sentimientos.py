...
def imprimir_puntuacion(puntuaciones_tweet):
        ...
        if(puntuaciones_tweet[5] > puntuaciones_tweet[6]):
            resultado = 1
        elif(puntuaciones_tweet[6] > puntuaciones_tweet[5]):
            resultado = 2
        ...
        #print(emociones[nums_emociones[5]]," : ",puntuaciones_tweet[5])
        #print(emociones[nums_emociones[6]]," : ",puntuaciones_tweet[6])
