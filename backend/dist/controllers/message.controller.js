...
var createMessage = function createMessage(_x, _x2) {
  return (_ref = _ref || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, logId, content, userId, message;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _req$body = req.body, logId = _req$body.logId, content = _req$body.content;
...
var getMessages = function getMessages(_x3, _x4) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 4:
          log = _context2.sent;
          _context2.next = 7;
          return _message["default"].findAll({
            where: {
