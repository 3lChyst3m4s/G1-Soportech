...
var getTasks = function getTasks(_x, _x2) {
...
var getTask = function getTask(_x5, _x6) {
...
var deleteTask = function deleteTask(_x7, _x8) {
...
var updateTask = function updateTask(_x9, _x10) {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.prev = 0;
          _context5.next = 3;
          return _taskModel["default"].update(req.body, {
            where: {
              id: req.params.id,
              userId: req.user.id
            },
